...
# Install requirements (Minimal Core for Data Acquisition)
# We use --user to avoid permissions issues and --prefer-binary for faster, safer install on Mac
"$QGIS_PYTHON" -m pip install --user --prefer-binary --no-cache-dir eodag shapely requests urllib3

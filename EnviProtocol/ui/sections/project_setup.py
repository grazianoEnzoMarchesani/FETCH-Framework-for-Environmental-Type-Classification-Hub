# -*- coding: utf-8 -*-
"""
EnviProtocol Dashboard - Project Setup Section
...
from qgis.core import (
    ...
    QgsSymbol, QgsSingleSymbolRenderer, QgsMessageLog, Qgis
)
...
class ProjectSetupSection(QgsCollapsibleGroupBox, HelpMixin):
    ...
    def _create_boundary_layer(self, extent, crs_authid):
        ...
        try:
            ...
            data_dir = os.path.join(base_dir, f"EnviProtocol+{project_name}")
            ...
            # Log error to QGIS Message Log instead of silently failing
            QgsMessageLog.logMessage(
                f"Errore nella creazione del layer di confine: {str(e)}",
                "EnviProtocol",
                Qgis.Critical
            )

...
class LCZCalculator:
    ...
    def classify_lcz(self, grid_path, log_callback=None, method='stable', apply_smoothing=True):
        ...
        processed = self.classification_proc.process(layer, log_callback, method=method, apply_smoothing=apply_smoothing)
